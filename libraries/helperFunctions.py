...
def add_to_embed(embed:discord.Embed or str or None, message:str or list, chars:int=1000, use_description:bool=True):
    ...
    if embed.author != None and embed.author != discord.embeds.Embed.Empty: dummy_embed.author = embed.author
    if embed.footer != None and embed.author != discord.embeds.Embed.Empty: dummy_embed.footer = embed.footer
    if embed.provider != None and embed.author != discord.embeds.Embed.Empty: dummy_embed.provider = embed.provider
